...
public class SpecificationBuilderExtensions_OrderByDescending
{
    ...
    [Fact]
    public void Should_AddOrderExpressionToListWithOrderByDescendingType_When_GivenOrderByDescendingExpression()
    {
        // Arrange
        ...
        spec.OrderExpressions.Single().OrderType.Should().Be(OrderByExpressionType.OrderByDescending);
    }
}
